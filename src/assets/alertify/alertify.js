    ...
    function Alertify() {
        ...
        var _alertify = {
            ...
            build: function(item) {
                ...
                if (item.type === "prompt") {
                    let inputHtml = this.dialogs.input
                    if (item.inputType) {
                        inputHtml = inputHtml.replace(`type='text'`, `type='${item.inputType}'`)
                    }
                    html += inputHtml
             ...
             * @return {Object}
             */
            dialog: function(message, type, onOkay, onCancel, inputType) {
                return this.setup({
                    type: type,
                    message: message,
                    onOkay: onOkay,
        ...
        return {
            ...
            prompt: function(message, onOkay, onCancel, inputType) {
                return _alertify.dialog(message, "prompt", onOkay, onCancel, inputType || 'text') || this;
            },
